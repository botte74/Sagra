<?php
	...
	class MYPDF extends TCPDF {
		...
		public function Header() {
			...
			// Title
			$this->Cell(0, 15, 'Sagra Mandria 2015 - RIEPILOGO GIORNALIERO', 10, false, 'C', 0, '', 0, false, 'M', 'M');
		}
	...
	$txt = '<table style="border: 1px solid #9A9A9A; padding:5px;">
				<tr style="border: 1px solid #9A9A9A;">
					...
					<td style="border: 1px solid #9A9A9A;"><b>GIORNO</b></td>
					<td style="border: 1px solid #9A9A9A;">'.$_SESSION['giorno'].'</td>
				</tr>
			</table>';
